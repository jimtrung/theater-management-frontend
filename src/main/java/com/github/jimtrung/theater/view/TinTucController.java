...
public class TinTucController implements Initializable {
    ...
    // Ví dụ nếu muốn có nút quay lại trang Home
    @FXML
    private void goHome() {
